...
(function() {
  $(function() {
    ...
    loadMessage = function(msg) {
      var comment_id, comment_sequence, content, content_type, content_values, headimg, msgType, msg_headimg_hide, msg_html, msg_nickname_hide, msg_owner, nickname, plus, plus_content, plus_content_destination, plus_type, ref, tel, time, timer, user_id;
      msgType = msg[0];
      roomId = msg[2];
      ...
      msg_owner = (ref = user_id === USER_ID) != null ? ref : {
        'wxmsg_self': 'wxmsg_other'
      };
      msg_headimg_hide = "";
      msg_nickname_hide = "";
