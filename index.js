...
(function() {
  $(function() {
    var base_room, base_rooms, formatDate, i, imgUrl, initialRoomId, initialRoomImg, initialRoomName, len, loadMessage, load_start, members_json, roomId, roomName, rooms_info, targetRoomId, time_now;
