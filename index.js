...
(function() {
  $(function() {
    var base_room, base_rooms, escapeHTML, formatDate, i, imgUrl, initialRoomId, initialRoomImg, initialRoomName, isLoadingMore, len, loadHistory, loadMessage, load_start, members_json, onRoomScroll, roomId, roomName, rooms_info, scrollIntoElement, targetRoomId, time_now;
    ...
    scrollIntoElement = function(currentRoomId, el) {
      var roomEl;
      roomEl = $(".comments_area");
      if (!typeof (el != null)) {
        return roomEl.stop().animate(function() {
          return {
